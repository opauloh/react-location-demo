...
export declare type Route<TGenerics extends PartialGenerics = DefaultGenerics> = RouteLoaders<TGenerics> & {
    path?: string;
...
export declare class RouterInstance<TGenerics extends PartialGenerics = DefaultGenerics> extends Subscribable {
    ...
    getMatchLoader: (next: Location<TGenerics>) => MatchLoader<TGenerics>;
...
export declare function useMatchRoute<TGenerics extends PartialGenerics = DefaultGenerics>(): (matchLocation: UseMatchRouteOptions<TGenerics>) => Maybe<TGenerics['Params'], Params<any>> | undefined;
...
export declare function Prompt({ message, when, children }: PromptProps): {} | null;
